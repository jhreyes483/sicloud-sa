        ...
        <table class="table table-striped bg-bordered bg-white table-sm col-md-10 col-sm-4 col-xs-12 mx-auto">
          <tbody>
            ...
            <tr>
              ...
              <a class="btn btn-success btn-circle" href=""><i class="fas fa-bell fa-fw"></i><a href="../../../vista/CU009-controlUsuarios.php?documento=<?php echo $row['descript'] ?>&accion=bId"><?php echo "  " .$row['nom_tipo'].$m.$row['descript'] ?></a></a>
              </td>
            </tr>
        <?php  }
